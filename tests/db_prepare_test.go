...
func TestDBPrepareQuery(t *testing.T) {
	...
	for _, tt := range tests {
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			stmt, err := db.PrepareQuery(context.Background(), tt.in)
			if err != nil {
				t.Error(err)
			}
			defer stmt.Close()
...
func TestDBPrepareQueryForMaster(t *testing.T) {
	...
	for _, tt := range tests {
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			stmt, err := db.PrepareQueryForMaster(context.Background(), tt.in)
			if err != nil {
				t.Error(err)
			}
			defer stmt.Close()
...
func TestDBPrepareMutation(t *testing.T) {
	...
	for _, tt := range tests {
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			stmt, err := db.PrepareMutation(context.Background(), tt.in)
			if err != nil {
				t.Error(err)
			}
			defer stmt.Close()
